...
;file is file name data is an array containing whether the ports
;passed or failed (1 is pass 0 is failed)
    compile_opt idl2
...
;print data to output file sorted by processor
    xxx = round(exptime*100)/100.0d
    print,endfile,' ',timfile,' ',pass,' ', round(total5),' ',xxx
