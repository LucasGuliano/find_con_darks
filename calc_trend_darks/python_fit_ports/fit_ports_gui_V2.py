...
#######################################################################
        ...
        #################################################################
        # SEPERATE TO MODEL AT GIVEN TIME AND FREEZE PARAMETERS BEFORE  #
        #                     Start of Model B                          #
        #                       07/09/2020                              #
        #################################################################
        self.seperation_2020 = 1.31025595e+09  #2020/07/08 11:59:59pm
        ################################################
...
################################################################################################################       
    ...
    def offset(self,dt0,amp1,amp2,p1,phi1,phi2,lin,quad,off):
        ...
        model_b_start = [(dt0 > self.seperation_2020 - self.t0dict[self.cport])]
